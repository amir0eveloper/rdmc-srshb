...
import { FileText, Download, Folder, Users } from "lucide-react";
            ...
            <CardContent>
              <ul className="space-y-3">
                {item.bitstreams.map((b) => (
                  <li
                    key={b.id}
                    className="flex items-center justify-between gap-4 p-2 rounded-md bg-gray-50 hover:bg-gray-100"
                  >
            ...
            <CardContent className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <Link
                    href={`/communities/${item.collection.community.id}`}
